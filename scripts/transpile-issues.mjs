...
log.info('Starting with transpiling all TypeScripts in the issues folder...');

const folder = path.resolve('issues');
const input = 'input';
const output = 'output';
...
log.info('Finished with transpiling all TypeScripts in the issues folder.');
